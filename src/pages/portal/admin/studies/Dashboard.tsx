...
const StudiesDashboard = () => {
  const navigation = [
    { name: 'Dashboard', href: '/portal/admin/studies', icon: GraduationCap },
    { name: 'Approve Materials', href: '/portal/admin/studies/materials', icon: CheckSquare },
    { name: 'Approve Results', href: '/portal/admin/studies/results', icon: FileText },
    { name: 'Academic Reports', href: '/portal/admin/studies/reports', icon: TrendingUp },
    { name: 'Educator Logs', href: '/portal/admin/studies/logs', icon: AlertCircle },
  ];

  return (
    <AdminLayout role="studies" navigation={navigation} roleTitle="Director of Studies">
