...
const BursarDashboard = () => {
  const navigation = [
    { name: 'Dashboard', href: '/portal/admin/bursar', icon: DollarSign },
    { name: 'Fee Management', href: '/portal/admin/bursar/fees', icon: Receipt },
    { name: 'Payment Tracking', href: '/portal/admin/bursar/payments', icon: CreditCard },
    { name: 'Financial Reports', href: '/portal/admin/bursar/reports', icon: FileText },
    { name: 'Fee Structures', href: '/portal/admin/bursar/structures', icon: TrendingUp },
  ];
