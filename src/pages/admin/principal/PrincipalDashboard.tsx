...
const PrincipalDashboard = () => {
  const navigation = [
    { name: 'Dashboard', href: '/admin/principal', icon: Shield },
    { name: 'Discipline Records', href: '/admin/principal/discipline', icon: AlertTriangle },
    { name: 'School Communications', href: '/admin/principal/communications', icon: Megaphone },
    { name: 'Daily Operations', href: '/admin/principal/operations', icon: FileText },
    { name: 'Staff Management', href: '/admin/principal/staff', icon: Users },
  ];
